...
│   └── see/                   MADCurator — SwiftUI native viewer + curation tool
...
14 interactive gallery experiences. Vanilla JS, no framework. Apple HIG design system with 74+ CSS custom properties. Each experience answers *"what can you do with 9,011 images and every possible signal?"*

**La Grille** / **Le Bento** / **La Similarite** / **La Derive** / **Les Couleurs** / **Le Terrain de Jeu** / **Le Flot** / **La Chambre Noire** / **Les Visages** / **La Boussole** / **L'Observatoire** / **La Carte** / **La Machine a Ecrire** / **Le Pendule**

### State — `frontend/state/`

Dashboard generated by `backend/dashboard.py`. 6 HTML pages: state (main), journal, instructions, drift, blind-test, mosaics. GitHub Pages deployment.

### See — `frontend/see/`

MADCurator. SwiftUI native macOS app. Reads directly from SQLite. 55 fields, 18 filter dimensions with union/intersection mode. Inline editing with DB write-back. The human eye decides what's worth showing.
