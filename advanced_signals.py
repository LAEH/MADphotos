...
def run_scene(conn, limit=0, force=False):
    ...
    labels_file = BASE_DIR / ".places365_labels.txt"
    ...
    weights_file = BASE_DIR / ".places365_resnet50.pth.tar"
...
def run_emotions(conn, limit=0, force=False):
    ...
    if not work:
        ...
        if "face_detections" not in tables:
            print("  No face_detections table found. Run signal_extraction.py first.")
            return 0
