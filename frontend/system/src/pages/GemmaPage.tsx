    ...
    <div className="gemma-card">
      <div className="gemma-card-left">
        <div className="gemma-card-img">
          <FadeImg
            src={imageUrl(`/rendered/mobile/jpeg/${result.uuid}.jpg`)}
            alt=""
            loading="lazy"
          />
        </div>
...
export function GemmaPage() {
  ...
  if (loading) return <div className="main-content"><p style={{ color: 'var(--muted)' }}>Loading Gemma analysis...</p></div>
    ...
    <div className="main-content">
      <div style={{ marginBottom: 'var(--space-8)' }}>
        ...
        <p style={{ fontSize: 'var(--text-sm)', color: 'var(--muted)' }}>
          Gemma 3 4B vision analysis of curated picks
        </p>
      </div>
      ...
      <div style={{
        ...
        marginBottom: 'var(--space-8)', padding: '12px 16px',
