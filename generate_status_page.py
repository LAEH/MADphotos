...
<div class="inst-hero">
  ...
  <p>Everything needed to work on MADphotos effectively. Updated 2026-02-06.</p>
</div>
...
<div class="inst-card">
  ...
  <table>
    ...
    <tbody>
      ...
      <tr><td><code>gcs_sync.py</code></td><td>Upload to GCS</td></tr>
      <tr><td><code>mad_database.py</code></td><td>SQLite schema (24 tables)</td></tr>
      <tr><td><code>enhance_engine.py</code></td><td>Camera-aware 6-step enhancement</td></tr>
      <tr><td><code>advanced_signals.py</code></td><td>11 ML models</td></tr>
      <tr><td><code>generate_status_page.py</code></td><td>Dashboard + Journal</td></tr>
    </tbody>
  </table>
</div>
...
<div class="inst-card">
  ...
  <div class="inst-grid" style="gap:var(--space-2);">
    <ul>
      ...
      <li><strong>Flat layout</strong> &mdash; <code>rendered/{tier}/{format}/{uuid}.ext</code>. Never <code>rendered/originals/</code> (plural)</li>
...
<div class="inst-card">
  ...
  <ul>
    ...
    <li><strong>gcs_sync.py</strong> uploads serving tiers only. Full/gemini tiers stay local (AI pipeline input).</li>
    <li><strong>Upload command:</strong> <code>python3 gcs_sync.py --version original</code> (or enhanced, blind)</li>
  </ul>
</div>
...
<div class="inst-card">
  ...
  <ul>
    ...
    <li>After ingestion, re-run <code>export_gallery_data.py</code> to update web data</li>
