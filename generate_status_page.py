...
<div class="inst-card">
  <h2>GCS Hosting</h2>
  <ul>
    <li><strong>Project:</strong> madbox-e4a35</li>
    <li><strong>Bucket:</strong> <code>gs://myproject-public-assets/art/MADphotos/</code></li>
    <li><strong>URL:</strong> <code>.../v/{version}/{tier}/{format}/{uuid}.ext</code></li>
    <li><strong>Versions:</strong> original, enhanced, blind</li>
  </ul>
</div>
