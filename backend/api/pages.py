"""Legacy HTML page generation — quarantined for eventual removal once React System replaces it."""
...
from ._common import (
    ...
    RENDERED_DIR, JOURNAL_PATH, human_bytes, pct,
)
from .vectors import _get_lance, similarity_search, drift_search
from .stats import get_stats
from .content import get_journal_html, get_instructions_html, get_mosaics_data
from .cartoons import get_cartoon_data, get_all_cartoon_data, review_cartoon
from .inspectors import (
    generate_signal_inspector_data, generate_embedding_audit_data,
    generate_collection_coverage_data, generate_schema_data,
)
...
BLIND_TEST_DIR = PROJECT_ROOT / "backend" / "ai_variants" / "blind_test"
